...
public class One1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent categoryIntent = new Intent(One1.this,Eleven11.class);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent categoryIntent = new Intent(One1.this,HomeActivity.class);
                startActivity(categoryIntent);
                finish();
               // showRewardedAd();
            }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent categogyIntent = new Intent(One1.this, HomeActivity.class);
